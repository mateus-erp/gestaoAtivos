...
import { Text, View, ScrollView, StyleSheet, Image, FlatList, TextInput, TouchableOpacity, Alert, ActivityIndicator } from 'react-native';
  ...
  return (
    <View style={theme.container}>
      <View style={theme.header}>
        <Text style={theme.text_header}>add Disciplina</Text>
        <TouchableOpacity onPress={()=>navigation.navigate('TelaCadastrarDisciplina')} style={theme.small_buttons}>
